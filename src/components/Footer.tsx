...
import { Heart, Mail, MapPin, Key, Users, Sparkles } from "lucide-react";
    ...
    <footer className="bg-brand-dark text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Menu */}
          <div>
            <h3 className="text-xs font-black uppercase tracking-[0.2em] text-gray-500 mb-5">Menu</h3>
            <ul className="space-y-2.5">
              ...
              <li><Link href="/checklist" className="text-gray-400 hover:text-white text-sm transition-colors">Checklists Rentrée</Link></li>
              <li><Link href="/contact" className="text-gray-400 hover:text-white text-sm transition-colors">Contact</Link></li>
              <li>
                <a href="https://donate.stripe.com/5kQaEQ6t57LC7KZ2jPb3q00" target="_blank" rel="noopener noreferrer"
          ...
          {/* Communauté — nouvelle colonne */}
          <div>
            <h3 className="text-xs font-black uppercase tracking-[0.2em] text-gray-500 mb-5">Communauté</h3>
            <ul className="space-y-2.5">
              <li>
                <Link href="/rejoindre"
                  className="inline-flex items-center gap-1.5 text-brand-green font-semibold text-sm hover:text-white transition-colors">
                  <Users size={13} /> Rejoindre l'association
                </Link>
              </li>
              <li>
                <Link href="/rejoindre#benevole"
                  ...
                  <Sparkles size={13} /> Devenir bénévole
                </Link>
              </li>
              <li>
                <Link href="/rejoindre#adhesion"
                  className="text-gray-400 hover:text-white text-sm transition-colors">
                  Frais d'adhésion
                </Link>
              </li>
          ...
          {/* Légal & Contact */}
          <div>
            <h3 className="text-xs font-black uppercase tracking-[0.2em] text-gray-500 mb-5">Contact & Légal</h3>
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-brand-green flex-shrink-0" />
                <a href="mailto:contact@marocainsenfrance.fr"
                  className="text-gray-400 hover:text-white text-sm transition-colors">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-400 text-sm">France</span>
              </li>
              <li className="pt-2 border-t border-gray-800">
                <Link href="/mentions-legales" className="text-gray-500 hover:text-white text-xs transition-colors">
                  Mentions légales
                </Link>
                <p className="text-gray-600 text-xs mt-1">SIRET : 990831778 · Loi 1901</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-5">
            <Link href="/admin/login" className="text-gray-600 hover:text-brand-green transition-colors" aria-label="Administration">
              <Key className="w-4 h-4" />
            </Link>
            <a href="https://www.instagram.com/marocainsenfrance" target="_blank" rel="noopener noreferrer"
              className="text-gray-500 hover:text-brand-green transition-colors" aria-label="Instagram">
