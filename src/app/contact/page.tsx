    ...
    <div className="pt-32 pb-24 bg-[#fafafa] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          >
            <div className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-xl shadow-gray-200/20 flex-grow relative overflow-hidden">
          ...
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            className="bg-white rounded-[3.5rem] p-10 md:p-16 border border-gray-100 shadow-2xl shadow-gray-200/40"
          >
            <ContactForm />
          </motion.div>
